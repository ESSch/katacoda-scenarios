...
1. Отправьте архив с файлами вашего решения вашему ментор для проверки. Создать `tar -cfv /tmp/exercise exercise.tar && doker run -d -p 9000:80 -v /tmp/exercise:/usr/share/nginx/html:ro nginx; `{{execute T1}} качать архив http://[[HOST_SUBDOMAIN]]-9000-[[KATACODA_HOST]].environments.katacoda.com/exercise.tar.
