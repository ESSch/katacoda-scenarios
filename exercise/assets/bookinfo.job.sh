...
#kubectl create -n default configmap tmp --from-dir=/tmp # /tmp/bookinfo-no-deployment.yaml /tmp/destination-rule-all-mtls.yaml
#kubectl create -n default configmap tmp --from-file=/istio-1.6.2/samples/bookinfo/networking/bookinfo-gateway.yaml
