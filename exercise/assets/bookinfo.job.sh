...
kubectl create -n default configmap gateway --from-file=/root/istio-1.6.2/samples/bookinfo/networking/bookinfo-gateway.yaml
...
kubectl exec -it $(kubectl get pods -l job-name=bookinfo -o jsonpath={@.items..metadata.name}) -c bookinfo -- kubectl get pods
