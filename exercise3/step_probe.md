...
Было принято решение для увеличения точности предсказания, по аналогии с ансамблем сетей и GoogLeNet, где используются в параллели предсказания для усреднения. Разработчик решил использовать цикл:
